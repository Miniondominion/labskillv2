...
BEGIN
  ...
  IF EXISTS (
    ...
    DROP TRIGGER update_portfolio_templates_updated_at ON portfolio_templates;
  END IF;
  ...
  IF EXISTS (
    ...
    DROP TRIGGER update_portfolio_sections_updated_at ON portfolio_sections;
  END IF;
  ...
  IF EXISTS (
    ...
    DROP TRIGGER update_portfolio_fields_updated_at ON portfolio_fields;
  END IF;
  ...
  IF EXISTS (
    ...
    DROP TRIGGER update_portfolio_instances_updated_at ON portfolio_instances;
  END IF;
  ...
  IF EXISTS (
    ...
    DROP TRIGGER update_portfolio_data_updated_at ON portfolio_data;
  END IF;
END $$;
...
BEGIN
  ...
  IF EXISTS (
    ...
    AND tablename = 'portfolio_templates'
  ) THEN
  ...
  IF EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE schemaname = 'public' 
    AND tablename = 'portfolio_sections'
  ) THEN
  ...
  IF EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE schemaname = 'public' 
    AND tablename = 'portfolio_fields'
  ) THEN
  ...
  IF EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE schemaname = 'public' 
    AND tablename = 'portfolio_instances'
  ) THEN
