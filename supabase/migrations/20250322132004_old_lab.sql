/*
  # Add Vital Signs Field Group
  
  1. New Fields
    - Creates a vital signs group with all required fields
    - Sets up proper field types and validation
    - Configures repeatable group settings
    
  2. Field Structure
    - All fields are part of the "vital_signs" group
    - Each field has appropriate type and validation
    - Group is repeatable for multiple sets of vitals
*/
